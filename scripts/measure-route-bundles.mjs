...
const routes = [
  ...
  { route: "/admin", role: "hr" },
  { route: "/admin/employees", role: "hr" },
  { route: "/admin/courses", role: "hr" },
  { route: "/admin/reports", role: "admin" },
  { route: "/admin/live-training", role: "hr" },
  { route: "/admin/quizzes", role: "hr" },
  { route: "/dashboard/quizzes", role: "employee" },
  { route: "/admin/learning-records", role: "hr" },
  ...
  ...[
    "/admin/assign", "/admin/learning-paths", "/admin/learning-paths/path-a", "/admin/sessions", "/admin/training-tracking",
    "/admin/cchn-registrations", "/admin/accounts", "/admin/competencies", "/admin/skills-matrix", "/admin/development-plans",
    "/admin/retraining", "/admin/compliance", "/admin/compliance/cycles/cycle-a", "/admin/certificates", "/admin/certifications",
