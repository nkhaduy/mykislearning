...
export function getEmployees() {
  ...
  return importedEmployees.map((employee) => {
    ...
    return {
      ...
      accountStatus: isDemoHr ? "active" : employee.dataIssue === "duplicate_email" ? "pendingReview" : account?.accountStatus || employee.accountStatus,
