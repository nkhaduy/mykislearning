...
const timeline = {
  2015: { image: "/assets/timeline/2015.jpeg", width: 432, height: 288, events: ["Thành lập các phòng giao dịch Bà Triệu và Nguyễn Tri Phương.", "Tăng vốn điều lệ từ 264 tỷ đồng lên 1.113 tỷ đồng."] },
  2016: { image: "/assets/timeline/2016.jpeg", width: 432, height: 268, events: ["Mở rộng mạng lưới tại Láng Hạ và Phạm Ngọc Thạch.", "Được vinh danh Top 10 thị phần môi giới tại HOSE và HNX."] },
  2018: { image: "/assets/timeline/2018.png", width: 554, height: 366, events: ["Trở thành thành viên giao dịch chứng khoán phái sinh.", "Tăng vốn điều lệ lên 1.897 tỷ đồng."] },
  2019: { image: "/assets/timeline/2019.jpeg", width: 432, height: 491, events: ["Là một trong bảy công ty đầu tiên được cấp chứng nhận phát hành chứng quyền.", "Chuyển chi nhánh Nguyễn Tri Phương thành chi nhánh Sài Gòn."] },
  2020: { image: "/assets/timeline/2020.png", width: 581, height: 822, events: ["Tăng vốn điều lệ lên 2.596 tỷ đồng và tỷ lệ sở hữu KIS Korea lên 99,7%.", "Đạt Top 9 thị phần môi giới HOSE."] },
  2021: { image: "/assets/timeline/2021.png", width: 514, height: 345, events: ["Tăng vốn điều lệ lên 3.761 tỷ đồng và tỷ lệ sở hữu KIS Korea lên 99,8%.", "Đạt Top 10 thị phần quý II tại HOSE."] },
  2025: { image: "/assets/timeline/2025.jpeg", width: 1199, height: 800, events: ["Tăng vốn điều lệ lên 4.550 tỷ đồng.", "TOP 9 thị phần môi giới HOSE năm 2025."] },
};
...
function render() {
  ...
  const leaders = [
    ["/assets/about/leader-shin-hyun-jae.jpg", "Shin Hyun Jae", "Tổng Giám đốc kiêm Chủ tịch Hội đồng Quản trị", "CEO & Chairman of the Board", "대표이사 겸 이사회 의장", 1080, 1389],
    ["/assets/about/leader-cho-hun-hee.jpg", "Cho Hun Hee", "Giám đốc cấp cao Khối Hoạt động & KHCN, Thành viên HĐQT", "Senior Director of Operations & IT, Board Member", "운영·IT 부문 고위이사, 이사회 이사", 1080, 1384],
    ["/assets/about/leader-choi-eun-suk.jpg", "Choi Eun Suk", "Thành viên Hội đồng Quản trị", "Member of the Board", "이사회 이사", 1050, 1470],
  ];
  ...
  app.innerHTML = `<div class="page about-page">
    ...
    <header class="header"><div class="container header-inner"><a class="brand" href="/"><img class="brand-logo" src="/assets/kis-logo-horizontal.png" alt="KIS" width="700" height="92" decoding="async"><span>MyKIS Learning</span></a><nav class="nav" id="public-nav" aria-label="${t.quickLinks}"><a href="/">${t.home}</a><a href="/about-kis" aria-current="page" class="is-active">${t.about}</a></nav><div class="header-actions">${languageSwitcher(current)}<button class="mobile-nav-toggle" type="button" data-mobile-nav-toggle aria-controls="public-nav" aria-expanded="false" aria-label="${t.menu}"><span aria-hidden="true">☰</span></button><a class="btn btn-primary header-mobile-cta" href="/login">${t.login}</a><a class="btn btn-primary btn--hero header-desktop-login" href="/login">${t.login}</a></div></div></header>
    ...
    <main id="main-content">
      ...
      <section class="network-v2"><div class="container"><div class="section-head"><div><span class="eyebrow">${t.networkEyebrow}</span><h2 class="section-title">${t.network}</h2><p class="section-lead">${t.networkLead}</p></div></div><div class="network-cards-v2">${networks.map(([title, meta]) => `<article class="network-card-v2"><h3 class="network-card-v2__title">${esc(title)}</h3><p class="network-card-v2__meta">${esc(meta)}</p></article>`).join("")}</div><div class="network-reference-map"><picture><source srcset="/assets/about/global-network.webp" type="image/webp"><img src="/assets/about/global-network.png" alt="${esc(t.network)}" width="3840" height="2160" loading="lazy" decoding="async"></picture></div></div></section>
      <section class="ceo-v2"><div class="container"><div class="section-head"><div><span class="eyebrow">${t.ceoEyebrow}</span><h2 class="section-title">${t.ceo}</h2></div></div><div class="ceo-card-v2"><span class="ceo-card-v2__quote" aria-hidden="true">&quot;</span><div class="ceo-card-v2__photo"><img src="/assets/about/tgd.jpeg" alt="Shin, Hyun Jae" width="1920" height="1664" loading="lazy" decoding="async"></div><div class="ceo-card-v2__body"><h3 class="ceo-card-v2__name">Shin, Hyun Jae</h3><span class="ceo-card-v2__role">${t.ceoRole}</span><div class="ceo-card-v2__letter">${ceoLetter.map((paragraph) => `<p>${esc(paragraph)}</p>`).join("")}</div></div></div></div></section>
    </main>
