...
} else if ((location.pathname.replace(/\/+$/, "") || "/") === "/admin") {
  document.write('<link rel="stylesheet" href="/src/shared/ui/route-shell.css?v=20260727-shared-type2">');
  document.write('<link rel="stylesheet" href="/src/features/admin/admin.css?v=20260727-route-split1">');
} else if ((location.pathname.replace(/\/+$/, "") || "/") === "/admin/employees") {
  document.write('<link rel="stylesheet" href="/src/shared/ui/route-shell.css?v=20260727-shared-type2">');
  document.write('<link rel="stylesheet" href="/src/features/employees/employees.css?v=20260728-employee-split1">');
} else if (/^\/admin\/courses(?:\/[^/]+)?$/.test(location.pathname.replace(/\/+$/, "") || "/") || /^\/dashboard\/courses\/[^/]+$/.test(location.pathname.replace(/\/+$/, "") || "/")) {
  document.write('<link rel="stylesheet" href="/src/shared/ui/route-shell.css?v=20260727-shared-type2">');
  document.write('<link rel="stylesheet" href="/src/features/courses/courses.css?v=20260728-course-split1">');
} else if (["/admin/quizzes", "/dashboard/quizzes", "/admin/learning-records", "/dashboard/certificates"].includes(location.pathname.replace(/\/+$/, "") || "/") || /^\/admin\/live-training(?:\/[^/]+)?$/.test(location.pathname.replace(/\/+$/, "") || "/")) {
  document.write('<link rel="stylesheet" href="/src/shared/ui/route-shell.css?v=20260727-shared-type2">');
...
} else if ((location.pathname.replace(/\/+$/, "") || "/") === "/admin/reports") {
  document.write('<link rel="stylesheet" href="/src/shared/ui/route-shell.css?v=20260727-shared-type2">');
