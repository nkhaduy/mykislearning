...
const configs = {
  ...
  "/hr/accounts": { copy: routeCopy("Tài khoản", "Accounts", "계정", "Yêu cầu hỗ trợ và hành động tài khoản được kiểm soát."), load: (api, _params, signal) => api("/api/admin/account-support/requests?pageSize=100", { signal }) },
