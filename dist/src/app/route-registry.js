...
export const ROUTE_DEFINITIONS = [
  ...
  { path: "/admin", roles: adminRoles, classification: "nav", navGroup: "overview", label: labels("Tổng quan", "Overview", "개요"), splitEntry: "admin" },
  { path: "/admin/courses", roles: adminRoles, classification: "nav", navGroup: "training", label: labels("Khóa học", "Courses", "과정"), splitEntry: "courseManagement" },
  { pattern: "/admin/courses/:id", roles: adminRoles, classification: "detail", parent: "/admin/courses", label: labels("Chi tiết khóa học", "Course detail", "과정 상세"), splitEntry: "courseManagement" },
  { path: "/admin/assign", roles: adminRoles, classification: "nav", navGroup: "training", label: labels("Giao khóa học", "Assignments", "과정 배정"), splitEntry: "adminSecondary" },
  { path: "/admin/quizzes", roles: adminRoles, classification: "nav", navGroup: "training", label: labels("Bài kiểm tra", "Quizzes", "퀴즈"), splitEntry: "quizzes" },
  { path: "/admin/learning-paths", roles: adminRoles, classification: "nav", navGroup: "training", label: labels("Lộ trình học", "Learning paths", "학습 경로"), splitEntry: "adminSecondary" },
  { pattern: "/admin/learning-paths/:id", roles: adminRoles, classification: "detail", parent: "/admin/learning-paths", label: labels("Chi tiết lộ trình", "Learning path detail", "학습 경로 상세"), splitEntry: "adminSecondary" },
  { path: "/admin/live-training", roles: adminRoles, classification: "nav", navGroup: "training", label: labels("Hành trình buổi học", "Live training", "실시간 교육"), splitEntry: "liveTraining" },
  { pattern: "/admin/live-training/:id", roles: adminRoles, classification: "detail", parent: "/admin/live-training", label: labels("Chi tiết buổi học", "Live session detail", "실시간 세션 상세"), splitEntry: "liveTraining" },
  { path: "/admin/sessions", roles: adminRoles, classification: "nav", navGroup: "training", label: labels("Lớp offline", "Offline classes", "오프라인 교육"), splitEntry: "adminSecondary" },
  { path: "/admin/training-tracking", roles: adminRoles, classification: "nav", navGroup: "training", label: labels("Theo dõi đào tạo", "Training tracking", "교육 추적"), splitEntry: "adminSecondary" },
  { path: "/admin/cchn-registrations", roles: adminRoles, classification: "nav", navGroup: "training", label: labels("Đăng ký học CCHN", "Certification registration", "자격 교육 등록"), splitEntry: "adminSecondary" },
  { path: "/admin/employees", roles: adminRoles, classification: "nav", navGroup: "people", label: labels("Nhân viên", "Employees", "직원"), splitEntry: "employees" },
  { path: "/admin/accounts", roles: adminRoles, classification: "nav", navGroup: "people", label: labels("Tài khoản", "Accounts", "계정"), splitEntry: "adminSecondary" },
  { path: "/admin/competencies", roles: adminRoles, classification: "nav", navGroup: "development", label: labels("Khung năng lực", "Competencies", "역량 체계"), splitEntry: "adminSecondary" },
  { path: "/admin/skills-matrix", roles: adminRoles, classification: "nav", navGroup: "development", label: labels("Ma trận kỹ năng", "Skills matrix", "역량 매트릭스"), splitEntry: "adminSecondary" },
  { path: "/admin/development-plans", roles: adminRoles, classification: "nav", navGroup: "development", label: labels("Kế hoạch phát triển", "Development plans", "개발 계획"), splitEntry: "adminSecondary" },
  { path: "/admin/retraining", roles: adminRoles, classification: "nav", navGroup: "development", label: labels("Tái đào tạo", "Retraining", "재교육"), splitEntry: "adminSecondary" },
  { path: "/admin/compliance", roles: adminRoles, classification: "nav", navGroup: "compliance", label: labels("Tuân thủ", "Compliance", "컴플라이언스"), splitEntry: "adminSecondary" },
  { pattern: "/admin/compliance/cycles/:id", roles: adminRoles, classification: "detail", parent: "/admin/compliance", label: labels("Chu kỳ tuân thủ", "Compliance cycle", "컴플라이언스 주기"), splitEntry: "adminSecondary" },
  { path: "/admin/certificates", roles: adminRoles, classification: "nav", navGroup: "compliance", label: labels("Chứng chỉ", "Certificates", "자격증"), splitEntry: "adminSecondary" },
  { path: "/admin/certifications", roles: adminRoles, classification: "redirect", parent: "/admin/certificates", redirectTo: "/admin/certificates", label: labels("Chứng chỉ", "Certificates", "자격증"), splitEntry: "adminSecondary" },
  { path: "/admin/learning-records", roles: adminRoles, classification: "nav", navGroup: "compliance", label: labels("Hồ sơ học tập", "Learning records", "학습 기록"), splitEntry: "learningRecords" },
  { path: "/admin/gallery", roles: adminRoles, classification: "nav", navGroup: "compliance", label: labels("Thư viện ảnh", "Gallery", "갤러리"), splitEntry: "adminSecondary" },
  { path: "/admin/reports", roles: adminRoles, classification: "nav", navGroup: "reports", label: labels("Báo cáo", "Reports", "보고서"), splitEntry: "reporting" },
  { path: "/admin/notifications", roles: adminRoles, classification: "nav", navGroup: "reports", label: labels("Thông báo", "Notifications", "알림"), splitEntry: "adminSecondary" },
  { path: "/admin/audit-log", roles: adminRoles, classification: "nav", navGroup: "reports", label: labels("Nhật ký kiểm toán", "Audit log", "감사 로그"), splitEntry: "adminSecondary" },
];
